                                ...
                                obj.map((e) => {
                                    return (
                                        <>
                                            ...
                                            <span className="button" onClick={() => selectSet(e.id)}
                                                style={
                                                    e.id == seat ? { backgroundColor: " #f84464" } : { color: "black" }
                                                }
                                            >{e.id}</span>
